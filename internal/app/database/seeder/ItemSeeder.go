...
func (seed *ItemSeeder) Seed() {
	...
	core.ResetAutoIncrement(ItemModel.ItemCategory{}.TableName())
	...
	core.ResetAutoIncrement(ItemModel.Item{}.TableName())
}
